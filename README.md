...
## まいけん起動手順
　1.ターミナルを開きcd image-uploaderで移動後,node server.jsと打ち込みサーバを起動\r
　2.新規ターミナルを開き,cd maiken-mainで移動.npm startと打ち込みフロントエンドを起動\r
　3.ターミナルの横のポートに移る.ポート欄に3000と3001の２つのポートを作製\r
　4.２つのポートを非公開か公開に変更\r
　5.3001ポートをブラウザで開き終了.\r
